package com.luxe.property.config;
...
@Configuration
public class PropertyGraphQLConfig implements WebMvcConfigurer {

    private final SubgraphAuthInterceptor authInterceptor;

    public PropertyGraphQLConfig(SubgraphAuthInterceptor authInterceptor) {
