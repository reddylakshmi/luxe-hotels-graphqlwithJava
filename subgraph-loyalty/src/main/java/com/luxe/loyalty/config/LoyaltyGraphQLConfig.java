package com.luxe.loyalty.config;
...
@Configuration
public class LoyaltyGraphQLConfig implements WebMvcConfigurer {

    private final SubgraphAuthInterceptor authInterceptor;

    public LoyaltyGraphQLConfig(SubgraphAuthInterceptor authInterceptor) {
